...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    ariaLabel: 'About',
    rotation: 8,
    hoverStyles: { bgColor: '#5176e1', textColor: '#ffffff' } // Blue-Purple (more blue)
  },
  {
    label: 'projects',
    href: '#projects',
    ariaLabel: 'Projects',
    rotation: 8,
    hoverStyles: { bgColor: '#6469cc', textColor: '#ffffff' } // Blue-Purple (50/50)
  },
  {
    label: 'skills',
    href: '#skills',
    ariaLabel: 'Skills',
    rotation: 8,
    hoverStyles: { bgColor: '#795dc7', textColor: '#ffffff' } // Purple-Blue (more purple)
  },
  {
    label: 'contact',
    href: '#contact',
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    ['--pill-bg']: menuBg,
                    ['--pill-color']: '#ffffff', // White text for pills
                    ...
                    height: 10,
                    border: '1px solid #8b5cf6' // Purplish-blue border
                  }}
                  ref={el => {
